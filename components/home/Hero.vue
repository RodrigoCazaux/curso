      ...
      <div class="relative px-6 lg:px-8">
        <div class="mx-auto max-w-2xl py-32">
          ...
          <div class="text-center">
            ...
            <div v-if="!is_suscribe" class="mt-10 flex items-center justify-center gap-x-6">
              <input v-model="email" type="text" placeholder="email..." class="px-4 py-2 border border-gray-500 focus:border-none"/>
              <button
                @click="subscribe"

<template>
  <div>
    ...
    <section
      class="flex flex-col justify-center items-center text-center relative py-10"
    >
      <h2>AlGUNOS DE NUESTROS VINOS</h2>
      <p class="leading-relaxed text-blueGray-500 z-10">
